...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            presentation::commands::chat_commands::execute_st_command,
            ...
            presentation::commands::chat_commands::set_chat_variable,
            presentation::commands::chat_commands::get_chat_variable,
            presentation::commands::chat_commands::list_chat_variables,
            presentation::commands::chat_commands::delete_chat_variable,
